# SM_LQs
Computational tools to implement a particle physics model that incorporates four new scalar leptoquark fields $\chi^u_1$, $\chi^u_2$, $\chi^d_1$ and $\chi^d_2$ to the Standard Model. The details of the model are discussed in:
